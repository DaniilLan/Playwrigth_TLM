...
from page_objects.base_page import MethodsPage
...
class TestPageAuth:
    ...
    def test_invalid_auth(self, page_auth, mail, password, expected_error):
        ...
        page_auth.fill_text(LocatorsAuth.INPUT_PASSWORD, password)
        page_auth.click(LocatorsAuth.BUTTON_LOG)
        page_auth.wait_visible_elements(LocatorsBase.NOTIFICATION_ALL)
        actual_error = page_auth.get_text(LocatorsBase.NOTIFICATION_ALL)
